...
const changeFilenameSafe = (origFilename) => {
    const ext = path_1.default.extname(origFilename);
    const base = path_1.default.basename(origFilename, ext);
        ...
        storage: (0, multer_1.diskStorage)({
            destination: (_req, _file, cb) => {
                ...
                splittedRelativePath.forEach((folder) => {
                    if (!(0, fs_1.existsSync)(incrementalPath + path_1.default.sep + folder)) {
                        (0, fs_1.mkdirSync)(incrementalPath + path_1.default.sep + folder);
                    }
                    incrementalPath = incrementalPath + path_1.default.sep + folder;
                });
...
const renameUploadedFile = (filename, directory = storagePaths_1.PRODUCTS_IMAGES_FOLDER_PATH) => {
    ...
    const fromPath = path_1.default.join(directory, filename);
    const toPath = path_1.default.join(directory, updatedFilename);
